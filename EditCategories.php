...
$sql_select_query = "select * from categories where id =".$_GET['id'].";";
...
$id = $row['id'];
    ...
    $update = "update categories set name = '$catName' where id =$id";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <!-- navvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv -->
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- Topbar Search -->
                    <h1 style="color: black; ">Edit Categories</h1>
            ...
            <!-- <h3 style="color: rgb(74, 74, 74); margin-left: 20px; font-weight:bold;"> Edit Categories</h3> -->
            <h4 style="margin-left: 20px; font-weight:bold;">Enter New Name :</h4> 
            
            
            <form style="margin-left: 20px; width: 80%;" method="post" action="">
                <div class="input-group mb-3">
                <input type="text" class="form-control" aria-label="Text input with checkbox" 
                value="<?php echo $row['name']; ?>" name="category" id="category" required>
                </div>
