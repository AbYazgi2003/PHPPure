        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <!-- navvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv -->
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- Topbar Search -->
                    <h1 style="color: black; ">ShowCategories </h1>
...
$perPage = 5; // Number of items per page
    ...
    $sql = "SELECT * FROM categories order by id asc LIMIT $offset, $perPage";
?>
<!-- ////////////////////////////////////////////////////////////////////////////// -->
...
<script>    
                ...
                window.location.href ="DeleteCategories.php?id="+a;
                ...
                <table class='table' style='margin-left: 50px; width: 80%;'>
                <tr>
                <th scope='col'>#</th>
                ...
                <td>
                <a href = "EditCategories.php?id=<?php echo $row['id']?>" class='btn btn-primary'> Edit </a>    
    ...
    <?php   } else {
		...
		// $st_id = $row0['id'];
		echo "<a href=ShowCategories.php?page=$i&category_id=3&num=1' class='btn btn-primary' 
				style='width:10px; height:40px;' >$i</a> ";			

			}else{
            echo "<a href='ShowCategories.PHP?page=$i' class='btn btn-primary' 
			style='width:10px; height:40px;' >$i</a> ";
			}
